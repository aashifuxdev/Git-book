...
<a class="button secondary"></a>Sidebar areaWhat you'll find
...
&#x20;[Jump to the 'Publish your documentation' step on this page](https://gitbook.com/docs/getting-started/quickstart#publish-your-documentation)
...
There are two ways to edit and update your content in GitBook — in our visual editor, or following a docs-as-code workflow. **You can choose one, or use a combination of both.** Whichever workflow you prefer, you'll edit your content using a **branch-based editing flow**. Find out more on [the Concepts page](https://gitbook.com/docs/reference/concepts).
...
Your site looks great out of the box — and under **Customize**, you can set your own [logo, colors, and font](https://gitbook.com/docs/manage-your-site/customization/icons-colors-and-themes), adjust the layout, and update your [site's visibility](https://gitbook.com/docs/manage-your-site/site-settings#audience).
...
Want to explore publishing in more detail? Check out [our complete guide to creating and publishing content in GitBook](https://gitbook.com/docs/guides/editing-and-publishing-documentation/complete-guide-to-publishing-docs-gitbook).
...
<a class="button secondary"></a>Your site’s default URL<a class="button secondary">Ask</a><a class="button secondary">Copy</a>

```
https://[organization-name].gitbook.io/[site-title]
```

While this may be suitable for some teams, many choose to change their URL to [a custom domain](https://gitbook.com/docs/publish/custom-domain) or [a custom subdirectory](https://gitbook.com/docs/publish/custom-domain/setting-a-custom-subdirectory).
